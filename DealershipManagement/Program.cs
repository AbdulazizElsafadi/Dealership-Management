...
builder.Services.AddScoped<Dealership_Management.Security.IOtpService, Dealership_Management.Security.OtpService>();
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Dealership Management API V1");
